...
public class AvaliacaoController {
	...
	// Altera a mensagem caso n�o esteja usando o ESELO (Nota e Resumo da
	...
	private void DefinirCorWebaxscore(String valorNota) {
		...
		// Define a cor do webaxscore na p�gina "Avaliar" de acordo a pontua��o
	...
	public void avaliarArquivo(UploadedFile file, boolean mark,
		...
		if (validate.uploadForm(file)) {
			...
			if (validate.conteudoUploadForm(html)) {
				...
				// Seta o valor do t�tulo no template
				tituloPagina = "Resumo de avalia��o por upload de arquivo - ASES";
				...
				// Atribui �ncora para as mensagens de erros dos campos vazios
	...
	public void avaliar(String url, boolean mark, boolean content,
		...
		if (validate.url(url)) {
			...
			// Seta o valor do t�tulo no template
			tituloPagina = "Resumo de avalia��o por URI - ASES";
			VRaptorRequestHolder.currentRequest().getServletContext().setAttribute("tituloPagina", tituloPagina);
	...
	// Verifica se o site de avalia��o de sintaxe css encontra-se no ar
	...
	// Verifica se o site de avalia��o de sintaxe html encontra-se no ar
	...
	public void avaliarPlainText(String html, boolean mark, boolean content,
		...
		if (validate.condigoFonte(html)) {
			...
			// Seta o valor do t�tulo no template
			tituloPagina = "Resumo de avalia��o por c�digo fonte - ASES";
			VRaptorRequestHolder.currentRequest().getServletContext()
	...
	public void detalhesAvaliacao(OccurrenceKey rn, boolean type) {
		String url = "";
		tituloPagina = "Detalhes da avalia��o - ASES";
		VRaptorRequestHolder.currentRequest().getServletContext()
				.setAttribute("tituloPagina", tituloPagina);
