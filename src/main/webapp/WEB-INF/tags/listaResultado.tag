...
<c:choose>
	...
	<thead>
		<tr>
			...
			<th id="erro_recomendacao_${cssClass}" class="topo2  indiceAvaliar1"> Recomendação </th>
			...
			<c:if test="${item.error }">
				<tr id="erro_numero_recomendacao_${cssClass}_${item.checkPoint}">
				  <!-- <td headers="erro_numero_recomendacao_${cssClass}" class="celula  indiceAvaliar0"><a class="sublinharLink" href="http://emag.governoeletronico.gov.br/#r${item.checkPoint}">${item.checkPoint} (link para um novo sítio)</a></td> --> 
				   <td headers="erro_recomendacao_${cssClass}" class="celula  indiceAvaliar0"><a class="sublinharLink" href="http://emag.governoeletronico.gov.br/#r${item.checkPoint}">${item.checkPoint} ${item.description}(link para um novo sítio)</a></td>
...
<c:choose>
	...
	<thead>
		<tr>
			...
			<th id="aviso_recomendacao_${cssClass}" class="topo2 indiceAvaliar1"> Recomendação </th>
		...
		<c:forEach items="${lista}" var="item">
			...
			<c:if test="${not item.error }">
				...
				<tr id="aviso_numero_recomendacao__${cssClass}_${item.checkPoint}">
			   		...
			   		<td headers="aviso_recomendacao_${cssClass}" class="celula indiceAvaliar1"><a  class="sublinharLink" href="http://emag.governoeletronico.gov.br/#r${item.checkPoint}">${item.checkPoint} ${item.description} (link para um novo sítio)</a></td>
