				 ...
				 <legend>Exportar Resultado</legend>
					 <p>
					   ...
					   <img
						...
						alt="pdf" title="Gerar em PDF" height="20" width="20">
					   <input type="radio" name="tiporel" value="4">PDF
					   
					   
					   <img
						src="${pageContext.request.contextPath}/inicial_arquivos/imagens/odt.png"
						alt="odt" title="Gerar em ODT" height="20" width="20">
					   <input type="radio" name="tiporel" value="3">ODT
					   <img
						src="${pageContext.request.contextPath}/inicial_arquivos/imagens/xls.png"
						alt="xls" title="Gerar em XLS" height="20" width="20">
					   <input type="radio" name="tiporel" value="2">XLS
					   <img
						src="${pageContext.request.contextPath}/inicial_arquivos/imagens/csv_text.png"
						alt="csv" title="Gerar em CSV" height="20" width="20">
					   <input type="radio" name="tiporel" value="5">CSV
					   <img
						src="${pageContext.request.contextPath}/inicial_arquivos/imagens/doc-rtf.png"
						alt="rtf" title="Gerar em RFT" height="20" width="20">
					   <input type="radio" name="tiporel" value="1">RTF
					
					
					
					   <label for="uri"><input id="url" name="url"
						value="${url}" size="50" type="hidden"></label>
						...
						<table  id="tabelaErros">
							...
							<tr>
								...
								<td class="topo"><img
									...
									alt="erro" height="20" width="20"> Erro(s) </td>
								<td class="topo"><img
									src="${pageContext.request.contextPath}/inicial_arquivos/imagens/alert.gif"
									alt="alerta" height="19" width="20"> Avisos </td>
							</tr>
				...
				<div class="outstanding-header">
					...
					<div class="domtab">
						...
						<div style="display: none;">
							...
							<t:listaResultado cssClass="multimedia"
						lista="${LISTA_MULTIMEDIA}" />
						</div>
